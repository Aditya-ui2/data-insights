...
export default function AddonSidebarPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#faf9f6] text-[#13322b] font-sans flex flex-col justify-between select-none antialiased relative">
      ...
      {/* LARGE FLOATING MODAL WINDOW OVERLAYING GOOGLE SHEETS (100% FAILSAFE) */}
      {showPreviewModal && (
        <div className="fixed inset-0 z-[99999999] bg-black/70 backdrop-blur-xs flex items-center justify-center p-2 md:p-6 animate-in fade-in zoom-in duration-150">
          <div className="bg-white rounded-3xl w-full max-w-6xl h-[92vh] shadow-2xl flex flex-col overflow-hidden border border-[#e5e2db]">
